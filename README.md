...
*Здесь собраны мои скромные наработки, "созданные" на пути моего становления как Data Engineer, ETL-разработчик, SQL-разработчик, разработчик DWH, Аналитик данных.*
